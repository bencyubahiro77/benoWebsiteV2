              ...
              <div className='grid lg:grid-cols-3 gap-0 xl:mr-28 xl:ml-28 mt-8 mb-20'>
                  ...
                  >
                    <div className='flex justify-between'>
                      ...
                      <a href='https://github.com/Mohamed-Hassan' target='_blank' rel='noopener noreferrer'>
                        <FontAwesomeIcon icon={faArrowUpRightFromSquare} style={{color: "#170e7d",}} className='h-4 w-4 mt-10 mb-2 mr-8' />
                      </a>
                    </div>

                    <h4 className='pl-8 text-xl font-bold'>Brogrammers E-commerce</h4>
                    ...
                    <ul className="flex ml-4 pl-[14px]">
